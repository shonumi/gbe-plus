...
void AGB_core::debug_process_command()
{
	...
	while(!valid_command)
	{
		...
		{
			std::cout<<"\nGBE+ Command Line Debugging Options (GBA Core):\n\n";
			...
			std::cout<<"w8\n\tWrite BYTE @ memory, format 0x1234ABCD for addr, 0x12 for value\n\n";
			std::cout<<"w16\n\tWrite HALFWORD @ memory, format 0x1234ABCD for addr, 0x1234 for value\n\n";
			std::cout<<"w32\n\tWrite WORD @ memory, format 0x1234ABCD for addr, 0x1234ABCD for value\n\n";
			std::cout<<"reg\n\tChange register value (0-36) \n\n";
			std::cout<<"dq\n\tQuit the debugger\n\n";
			...
			std::cout<<"ri\n\tRuns emulation for a # of instructions, format 0x1234ABCD\n\n";
			std::cout<<"rs\n\tReset emulation\n\n";
