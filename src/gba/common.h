...
const u32 PY_NMP_PARAMETER = 0xE008000;
const u32 PY_NMP_DATA_IN = 0xE004000;
const u32 PY_NMP_DATA_OUT = 0xE006000;
...
const u32 CAM_ROM_DATA_HI_B = 0xA008000;
...
const u32 TV_FLASH_INIT = 0x8000000;
const u32 TV_FLASH_CMD0 = 0x8000AAA;
const u32 TV_FLASH_CMD1 = 0x8000554;
const u32 TV_FLASH_DATA = 0x8020000;
