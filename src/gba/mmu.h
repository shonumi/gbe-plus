...
class AGB_MMU
{
	...
	enum play_yan_commands
	{
		...
		PLAY_YAN_SEEK = 0x905,
		PLAY_YAN_SLEEP_DURING_PLAYBACK = 0x906,
	...
	enum tv_tuner_states
	{
		...
		TV_TUNER_NEXT_DATA,
		TV_TUNER_READ_DATA,
		TV_TUNER_SET_CONTRAST = 0x10,
		TV_TUNER_SET_BRIGHTNESS = 0x11,
		TV_TUNER_SET_HUE = 0x15,
	...
	struct cam_001
	{
		...
		std::vector <u8> microphone_out_buffer;
		u32 network_state;
		bool network_init;
	} campho;
	...
	bool play_yan_grab_frame_data(u32 frame);
