...
void ARM7::dma1()
{
	...
	else
	{
		...
		mem->dma[1].control = mem->read_u16_fast(DMA1CNT_H);
		mem->dma[1].dest_addr_ctrl = (mem->read_u16_fast(DMA1CNT_H) >> 5) & 0x3;
		mem->dma[1].src_addr_ctrl = (mem->read_u16_fast(DMA1CNT_H) >> 7) & 0x3;
...
void ARM7::dma2()
{
	...
	else
	{
		...
		mem->dma[2].control = mem->read_u16_fast(DMA2CNT_H);
		mem->dma[2].dest_addr_ctrl = (mem->read_u16_fast(DMA2CNT_H) >> 5) & 0x3;
		mem->dma[2].src_addr_ctrl = (mem->read_u16_fast(DMA2CNT_H) >> 7) & 0x3;
