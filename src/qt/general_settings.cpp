...
void gen_settings::set_ini_options()
{
	...
	else if(config::fragment_shader == (config::data_path + "shaders/grayscale.fs")) { ogl_frag_shader->setCurrentIndex(7); }
	else if(config::fragment_shader == (config::data_path + "shaders/lcd_mode.fs")) { ogl_frag_shader->setCurrentIndex(8); }
	else if(config::fragment_shader == (config::data_path + "shaders/pastel.fs")) { ogl_frag_shader->setCurrentIndex(9); }
	else if(config::fragment_shader == (config::data_path + "shaders/scale2x.fs")) { ogl_frag_shader->setCurrentIndex(10); }
	else if(config::fragment_shader == (config::data_path + "shaders/scale3x.fs")) { ogl_frag_shader->setCurrentIndex(11); }
	else if(config::fragment_shader == (config::data_path + "shaders/sepia.fs")) { ogl_frag_shader->setCurrentIndex(12); }
	else if(config::fragment_shader == (config::data_path + "shaders/spotlight.fs")) { ogl_frag_shader->setCurrentIndex(13); }
	else if(config::fragment_shader == (config::data_path + "shaders/tv_mode.fs")) { ogl_frag_shader->setCurrentIndex(14); }
	else if(config::fragment_shader == (config::data_path + "shaders/washout.fs")) { ogl_frag_shader->setCurrentIndex(15); }
...
void gen_settings::ogl_frag_change()
{
	switch(ogl_frag_shader->currentIndex())
	{
		...
		case 7: config::fragment_shader = config::data_path + "shaders/grayscale.fs"; break;
		case 8: config::fragment_shader = config::data_path + "shaders/lcd_mode.fs"; break;
		case 9: config::fragment_shader = config::data_path + "shaders/pastel.fs"; break;
		case 10: config::fragment_shader = config::data_path + "shaders/scale2x.fs"; break;
		case 11: config::fragment_shader = config::data_path + "shaders/scale3x.fs"; break;
		case 12: config::fragment_shader = config::data_path + "shaders/sepia.fs"; break;
		case 13: config::fragment_shader = config::data_path + "shaders/spotlight.fs"; break;
		case 14: config::fragment_shader = config::data_path + "shaders/tv_mode.fs"; break;
		case 15: config::fragment_shader = config::data_path + "shaders/washout.fs"; break;
	}
