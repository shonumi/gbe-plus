...
main_menu::main_menu(QWidget *parent) : QWidget(parent)
{
	...
	QLabel* emu_title = new QLabel("GBE+ 1.8");
	...
	QLabel* emu_copyright = new QLabel("Copyright D.S. Baxter 2014-2024");
	QLabel* emu_proj_copyright = new QLabel("Copyright GBE+ Team 2014-2024");
...
void main_menu::boot_game()
{
	...
	switch(settings->special_cart->currentIndex())
	{
		...
		case 0x10: config::cart_type = AGB_GLUCOBOY; break;
		case 0x11: config::cart_type = AGB_TV_TUNER; break;
		case 0x12: config::cart_type = NDS_IR_CART; break;
	}
