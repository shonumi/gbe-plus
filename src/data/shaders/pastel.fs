...
// File : pastel.fs
// Date : August 18, 2016
// Description : GBE+ Fragment Shader - Pastel
//
// Desaturates the colors and raises lightness to mimic pastel color palettes
// Washes out the screen similar to old Game Boy screens as well.
...
void main()
{
	...
	//Increase lightness
	hsl[2] *= lightness_delta;
	if(hsl[2] > 1.0){ hsl[2] = 1.0; }

	//Decrease saturation
	hsl[1] *= saturation_delta;
