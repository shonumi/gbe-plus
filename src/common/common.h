...
const u32 DMG_SAVE_STATE_VERSION = 0x03;
const u32 SGB_SAVE_STATE_VERSION = 0x04;
const u32 AGB_SAVE_STATE_VERSION = 0x02;
const u32 MIN_SAVE_STATE_VERSION = 0x02;
const u32 NTR_SAVE_STATE_VERSION = 0x05;
