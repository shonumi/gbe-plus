...
const u32 DMG_SAVE_STATE_VERSION = 0x01;
const u32 SGB_SAVE_STATE_VERSION = 0x01;
const u32 AGB_SAVE_STATE_VERSION = 0x01;
const u32 MIN_SAVE_STATE_VERSION = 0x01;
const u32 NDS_SAVE_STATE_VERSION = 0x01;
